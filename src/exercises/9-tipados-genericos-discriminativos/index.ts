...
function startTheApp(callback: (error: Error | null) => void) {
    requestAdmins((adminsResponse: ApiResponse<Admin[]>) => {
        ...
        requestUsers((usersResponse:ApiResponse<User[]>) => {
            console.log('Users:');
            ...
            requestCurrentServerTime((serverTimeResponse: ApiResponse<number>) => {
                ...
                requestCoffeeMachineQueueLength((coffeeMachineQueueLengthResponse: ApiResponse<number>) => {
